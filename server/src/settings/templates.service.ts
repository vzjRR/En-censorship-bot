...
export const TEMPLATE_DEFINITIONS: Record<TemplateKey, TemplateDefinition> = {
  ...
  warning: {
    ...
    placeholders: ["playerRef", "warningNumber", "reason", "issuedDate", "duration", "staffName"],
    default: [
  ...
  ban: {
    ...
    placeholders: ["identifier", "duration", "reason", "date", "staffMention"],
    default: [
